...
#if 0
  DBGVV("ptpd_servo_update_offset: ingress_timestamp %li seconds %li nanoseconds\n",
        sync_event_ingress_timestamp->seconds,
        sync_event_ingress_timestamp->nanoseconds);
  DBGVV("ptpd_servo_update_offset: origin_timestamp %li seconds %li nanoseconds\n",
        precise_origin_timestamp->seconds,
        precise_origin_timestamp->nanoseconds);
  DBGVV("ptpd_servo_update_offset: correction_field %li seconds %li nanoseconds\n",
...
#if 1
  DBGVV("ptpd_servo_update_delay: receive_timestamp %li seconds %li nanoseconds\n",
        receive_timestamp->seconds,
        receive_timestamp->nanoseconds);
  DBGVV("ptpd_servo_update_delay: egress_timestamp %li seconds %li nanoseconds\n",
...
void ptpd_servo_update_clock(PtpClock *ptp_clock)
{
  ...
  {
    case E2E:
      DBG("PTPD: ptpd_servo_update_clock: one-way delay averaged (E2E): %li sec %li nsec\n",
